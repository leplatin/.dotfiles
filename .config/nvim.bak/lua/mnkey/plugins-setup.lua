...
return require("packer").startup(function(use)
	...
	-- vs-code like css colors highlights
	use({
		"RRethy/vim-hexokinase",
		run = "make hexokinase",
		setup = function()
			vim.g.Hexokinase_highlighters = { "foregroundfull", "virtual" }
		end,
	})
	...
	use("terrortylor/nvim-comment") -- comment lines by pressing 'gcc' and paragraphs by 'gs'
	...
	-- to read and write files with sudo
